function [model, grad] = calc_gradient(model, input, activations, dv_output)
...
%     tic;
    [~, dv_output, grad{i}, model.layers(i).params] = layer.fwd_fn(activations{i}, layer.params, layer.hyper_params, true, dv_output);

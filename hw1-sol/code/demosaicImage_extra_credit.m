function output = demosaicImage_extra_credit(im, method)
...
%   to 
%  "[colorIm, predShift] = alignChannels_extra_credit(channels, maxShift);"
...
temp1 = mosim(:,:,1);
temp3 = mosim(:,:,3);
temp1(1:2:imageHeight, 1:2:imageWidth) = ... 
    mosim(1:2:imageHeight, 1:2:imageWidth, 1) ./ mosim(1:2:imageHeight, 1:2:imageWidth, 2);
temp3(2:2:imageHeight, 2:2:imageWidth) = ...
    mosim(2:2:imageHeight, 2:2:imageWidth, 3) ./ mosim(2:2:imageHeight, 2:2:imageWidth, 2);
temp1(isinf(temp1)) = 1;
temp3(isinf(temp3)) = 1;
temp1(isnan(temp1)) = 0;
temp3(isnan(temp3)) = 0;

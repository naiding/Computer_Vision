...
for i = 1:numImages
    ...
    [imageHeight, imageWidth, ~] = size(channels);
...
%     toc;
%     tic;
%     [colorIm, predShift] = alignChannels(channels(:,1:round(imageWidth/2),:), maxShift);
%     [colorIm2, predShift] = alignChannels(channels(:,round(imageWidth/2)+1:imageWidth,:), maxShift);
%     colorIm = cat(2, colorIm1, colorIm2);
%     toc;

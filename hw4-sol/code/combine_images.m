...
% Paste the two images
im_r(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 1);
im_g(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 2);
im_b(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 3);

im_r(oy2+(1:h2), ox2+(1:w2)) = im2(:, :, 1);
im_g(oy2+(1:h2), ox2+(1:w2)) = im2(:, :, 2);
im_b(oy2+(1:h2), ox2+(1:w2)) = im2(:, :, 3);

im_tmp_r = sparse(h, w);
im_tmp_g = sparse(h, w);
im_tmp_b = sparse(h, w);

im_tmp_r(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 1);
im_tmp_g(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 2);
im_tmp_b(oy1+(1:h1t), ox1+(1:w1t)) = im1t(:, :, 3);
...
im = cat(3, full(im_r), full(im_g), full(im_b));
